...
mysqli_query($c, "INSERT INTO ubicacion (x, y, tipo, id_usuario) VALUES (2, 5, 'Ciudad', 2)");
...
mysqli_query($c, "INSERT INTO ubicacion (x, y, tipo, id_usuario) VALUES (1, 2, 'Puesto_comercial', 1)");

mysqli_query($c, "INSERT INTO ubicacion (x, y, tipo, id_usuario) VALUES (4, 7, 'Puesto_comercial', 3)");

mysqli_query($c, "INSERT INTO ubicacion (x, y, tipo, id_usuario) VALUES (5, 9, 'Puesto_comercial', 4)");
...
mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('molino de agua', '00:20:30', 300,200,0,1000,0,100,0,400)");
...
mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('parque solar', '02:00:00', 5000, 1000, 500, 6000, 0, 0, 0, 500)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('ayuntamiento', '03:30:00', 8000, 2000, 1000, 500, 7, 0, 0, 1000)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('hospital', '02:30:00', 6000, 1500, 800, 6000, 7, 0, 0, 800)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('biblioteca', '00:10:00', 500, 100, 0, 1000, 0, 0, 0, 0)");
...
mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('fabrica-2', '00:20:00', 1500, 500, 0, 2000, 0, 0, 0, 0)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('hotel', '02:30:00', 7000, 2500, 1500, 7000, 6, 0, 0, 800)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('iglesia', '02:00:00', 6000, 1800, 1000, 6000, 5, 0, 0, 1000)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('mina de piedra', '01:00:00', 3000, 1000, 500, 3000, 0, 0, 0, 300)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('parque solar', '01:30:00', 4000, 1500, 800, 4000, 0, 0, 300, 0)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('piscina', '02:30:00', 7000, 2000, 1500, 7000, 0, 0, 0, 800)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('presa hidroelectrica', '03:00:00', 8000, 2500, 2000, 8000, 0, 0, 400, 400)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('restaurante', '02:30:00', 7000, 2000, 1000, 7000, 0, 0, 0, 1000)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('universidad', '03:00:00', 8000, 1500, 2500, 8000, 0, 0, 0, 600)");
...
mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('estacion de autobuses', '03:00:00', 8000, 2500, 1000, 8000, 0, 0, 400, 0)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('museo', '02:00:00', 6000, 2000, 800, 6000, 0, 0, 300, 300)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('supermercado', '03:30:00', 9000, 2500, 2000, 9000, 0, 0, 400, 400)");

mysqli_query($c, "INSERT INTO tipo (nombre, tiempo, coste_dinero, coste_comida, coste_energia, pob_requerida, edif_requeridos, efecto_dinero, efecto_comida, efecto_energia) VALUES ('farmacia', '02:00:00', 6000, 1500, 1000, 6000, 0, 0, 0, 600)");
